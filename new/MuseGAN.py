...
class RandomWeightedAverage(Layer):
    ...
    """Создание среднего между реальным и сгенерированным образцом"""
...
class MuseGAN():
    ...
    def _build_adversarial(self):
        ...
        # Вывод критика по реальному и созданному образцам
        fake = self.critic(fake_img)
        valid = self.critic(real_img)

        # создание взвешенного среднего между реальным и созданным образцом
        interpolated_img = RandomWeightedAverage(self.batch_size)([real_img, fake_img])
        # оценка критиком среднего
